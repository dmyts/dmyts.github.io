...
$sql = "SELECT h2, h3, descript, code FROM materi_php";
...
<head>
    ...
    <meta name="description" content="Halaman Pembelajaran PHP Dasar">
    <meta name="keywords" content="HTML, CSS, PHP, TailwindCSS">
    <meta name="author" content="Nama Anda">
    <title>Pembelajaran PHP Dasar</title>
...
<main class="container mx-auto py-10 px-6">
    ...
    <section class="mb-12">
        ...
        <div class="p-4 bg-white rounded-md shadow-md">
            <pre class="bg-gray-200 p-4 rounded-md"><code class="language-php">
            <?php echo $row2["code"]; ?>
            </pre>
        </div>
    </section>
    ...
    <!-- Section: Kontrol Alur -->
    <section class="mb-12">
        <h2 class="text-3xl font-bold mb-4"><?php echo $row4["h2"]; ?></h2>
        <p class="text-lg"><?php echo $row4["descript"]; ?></p>
        <div class="p-4 bg-white rounded-md shadow-md">
            <h3 class="text-2xl font-semibold mb-4"><?php echo $row4["h3"]; ?></h3>
            <pre class="bg-gray-200 p-4 rounded-md"><code class="language-php">
            <?php echo $row4["code"]; ?>
            </pre>
        </div>
        <div class="p-4 bg-white rounded-md shadow-md mt-4">
            <h3 class="text-2xl font-semibold mb-4"><?php echo $row5["h2"]; ?></h3>
            <pre class="bg-gray-200 p-4 rounded-md"><code class="language-php">
            <?php echo $row5["code"]; ?>
            </pre>
        </div>
