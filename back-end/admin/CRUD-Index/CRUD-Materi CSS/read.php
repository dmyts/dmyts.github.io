<?php 
  ...
  $sql = "SELECT id, h2, h3, descript FROM materi_css"; 
...
<head>
  ...
  <title>Read Materi CSS</title>
</head>
<body class="bg-gray-100">
  <div class="container mx-auto my-8">
    <h2 class="text-2xl font-bold text-center py-8">Materi CSS</h2>
      ...
      <table class="min-w-full bg-white shadow-md rounded-lg">
        <thead>
          <tr class="bg-gray-800 text-white">
            ...
            <th class="w-6/12 py-3 px-4 uppercase font-semibold text-sm">Heading 2</th>
