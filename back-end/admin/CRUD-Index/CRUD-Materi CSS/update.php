...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {
    if (isset($_POST["id"], $_POST["h2"], $_POST["h3"], $_POST["descript"])) {
        ...
        $sql = "UPDATE materi_html SET h2='$h2', h3='$h3', descript='$descript' WHERE id='$id'";
...
if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM materi_css WHERE id='$id'";
    ...
    <div class="max-w-md mx-auto bg-white p-8 rounded-md shadow-md">
        ...
        <form action="" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="h2" id="h2" value="<?php echo htmlspecialchars($row['h2']); ?>" class="w-full px-4 py-2 border rounded-md">
            </div>
            <div class="mb-4">
                <label for="h2" class="block font-medium mb-1">Heading 2</label>
                <input type="text" name="h3" id="h3" value="<?php echo htmlspecialchars($row['h3']); ?>" class="w-full px-4 py-2 border rounded-md">
            </div>
            <div class="mb-4">
