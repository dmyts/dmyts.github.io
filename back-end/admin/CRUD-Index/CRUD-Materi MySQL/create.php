...
<head>
    ...
    <title>Create Materi MySQL</title>
...
<body class="bg-gray-100">
    <div class="container mx-auto py-12">
        <div class="max-w-md mx-auto bg-white p-8 rounded shadow-md">
            <h2 class="text-2xl font-bold mb-6 text-center">Create Materi MySQL</h2>
            <form action="./savedata.php" method="POST">
                ...
                <div class="mb-4">
                    <label for="list" class="block text-gray-700 font-bold mb-2">List</label>
                    <input type="text" name="list" id="List" class="w-full px-3 py-2 border rounded-md 
                    focus:outline-none focus:border-blue-500" placeholder="Enter heading 1">
                </div>
