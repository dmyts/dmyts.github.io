...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {
    if (isset($_POST["id"], $_POST["h2"], $_POST["descript"])) {
        ...
        $sql = "UPDATE materi_html SET h2='$h2',list='$list' , descript='$descript' WHERE id='$id'";
...
<body class="bg-gray-100 p-10">
    <div class="max-w-md mx-auto bg-white p-8 rounded-md shadow-md">
        ...
        <form action="" method="POST">
            ...
            <div class="mb-4">
                <label for="list" class="block font-medium mb-1">List</label>
                <input type="text" name="list" id="h2" value="<?php echo htmlspecialchars($row['list']); ?>" class="w-full px-4 py-2 border rounded-md" required>
            </div>
