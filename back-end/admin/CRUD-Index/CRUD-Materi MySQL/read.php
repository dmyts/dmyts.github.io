<?php 
  ...
  $sql = "SELECT id, h2, descript, list FROM materi_mysql"; 
...
<head>
  ...
  <title>Read Materi MySQL</title>
</head>
<body class="bg-gray-100">
  <div class="container mx-auto my-8">
    <h2 class="text-2xl font-bold text-center py-8">Materi MySQL</h2>
      ...
      <table class="min-w-full bg-white shadow-md rounded-lg">
        <thead>
          <tr class="bg-gray-800 text-white">
            ...
            <th class="w-2/12 py-3 px-4 uppercase font-semibold text-sm">List</th>
        ...
        <tbody>
          ...
          ?>
            <tr class="bg-white hover:bg-gray-100 border-b border-gray-200">
              ...
              <td class="py-3 px-4"><?php echo $row["list"]; ?></td>
