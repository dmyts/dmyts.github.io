<?php 
  ...
  $sql = "SELECT id, h2, h3, descript, code FROM materi_php"; 
...
<head>
  ...
  <title>Read Materi PHP</title>
</head>
<body class="bg-gray-100">
  <div class="container mx-auto my-8">
    <h2 class="text-2xl font-bold text-center py-8">Materi PHP</h2>
    <div class="overflow-x-auto">
      <table class="min-w-full bg-white shadow-md rounded-lg">
        <thead>
          <tr class="bg-gray-800 text-white">
            <th class="w-1/12 py-3 px-4 uppercase font-semibold text-sm">ID</th>
            <th class="w-2/12 py-3 px-4 uppercase font-semibold text-sm">Heading</th>
            <th class="w-2/12 py-3 px-4 uppercase font-semibold text-sm">Heading 2</th>
        ...
        <tbody>
          ...
          ?>
            <tr class="bg-white hover:bg-gray-100 border-b border-gray-200">
              ...
              <td class="py-3 px-4"><?php echo $row["h3"]; ?></td>
